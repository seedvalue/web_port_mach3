...
Shader "Shader Forge/Blending/BlendAdd_Power"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 tmpvar_7;
          tmpvar_7.xyz = clamp((((in_f.xlv_COLOR.w * (_Texture_var_2.xyz + _Texture2_var_1.x)) * in_f.xlv_COLOR.xyz) * _Power), 0, 1);
          tmpvar_7.w = clamp(((in_f.xlv_COLOR.w * _Texture2_var_1.x) * _AlphaPower), 0, 1);

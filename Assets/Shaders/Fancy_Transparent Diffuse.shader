...
Shader "Fancy/Transparent Diffuse"
{
  Properties
  {
    ...
    [KeywordEnum(DISABLED, ENABLED)] FANCY_VERTEX_ALPHA ("Features/Vertex Color Alpha", float) = 0
    _MainTex ("General/Base (RGB)", 2D) = "white" {}
    [NeedsKeywordDrawer(FANCY_COLOR_MASK_ENABLED)] _Color ("General/Color mask", Color) = (1,1,1,1)
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      // m_ProgramMask = 6
      CGPROGRAM
      #pragma multi_compile DIRECTIONAL FANCY_COLOR_MASK_DISABLED LIGHTMAP_OFF DIRLIGHTMAP_OFF DYNAMICLIGHTMAP_OFF SHADOWS_OFF FANCY_REFLECTIONS_DISABLED VERTEXLIGHT_OFF FANCY_FOG_DISABLED FANCY_VERTEX_ALPHA_DISABLED FANCY_FORCED_VERTEXLIGHT_OFF
      //#pragma target 4.0
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float3 tmpvar_15;
          float _tmp_dvx_28 = max(((1.055 * pow(max(res_11, float3(0, 0, 0)), float3(0.4166667, 0.4166667, 0.4166667))) - 0.055), float3(0, 0, 0));
          tmpvar_15 = float3(_tmp_dvx_28, _tmp_dvx_28, _tmp_dvx_28);
          res_11 = tmpvar_15;

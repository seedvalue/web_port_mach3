...
Shader "Shader Forge/FX_FrameLines"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_8;
          tmpvar_8 = ((_Texture_var_2.xyz * in_f.xlv_COLOR.xyz) * ((in_f.xlv_COLOR.w * _Alpha_var_1.xyz) * _Power));
          float4 tmpvar_9;
          tmpvar_9.xyz = float3(clamp(tmpvar_8, 0, 1));

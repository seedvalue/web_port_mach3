...
Shader "Shader Forge/FX_Void_Erossion"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float2 tmpvar_6;
          float2 tmpvar_7;
          tmpvar_7 = (_UVScale * in_f.xlv_TEXCOORD0);
          tmpvar_6 = ((tmpvar_7 + ((_Speed1X * tmpvar_5.y) * float2(1, 0))) + ((tmpvar_5.y * _Speed1Y) * float2(0, 1)));
          float4 tmpvar_8;
          tmpvar_8 = tex2D(_MainTex, tmpvar_6);
          _Texture_2 = tmpvar_8;
          float2 tmpvar_9;
          tmpvar_9 = ((tmpvar_7 + ((_Speed2X * tmpvar_5.y) * float2(1, 0))) + ((tmpvar_5.y * _Speed2Y) * float2(0, 1)));
          float4 tmpvar_10;
          tmpvar_10 = tex2D(_MainTex, tmpvar_9);
          _Texture2_1 = tmpvar_10;
          float x_11;
          x_11 = (((_Mask_3.z * (_Texture_2.x + _Texture2_1.y)) - (1 - (in_f.xlv_COLOR.w * 0.9))) - 0.5);
          if((x_11<0))
          {
              discard;
          }
    ...
    Pass // ind: 2, name: SHADOWCASTER
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float2 tmpvar_6;
          float2 tmpvar_7;
          tmpvar_7 = (_UVScale * in_f.xlv_TEXCOORD1);
          tmpvar_6 = ((tmpvar_7 + ((_Speed1X * tmpvar_5.y) * float2(1, 0))) + ((tmpvar_5.y * _Speed1Y) * float2(0, 1)));
          float4 tmpvar_8;
          tmpvar_8 = tex2D(_MainTex, tmpvar_6);
          _Texture_2 = tmpvar_8;
